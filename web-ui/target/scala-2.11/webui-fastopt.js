...
$c_Lcalculator_Calculator$.prototype.eval$1__p1__Lcalculator_Expr__sci_Map__sci_List__D = (function(expr, references, acc) {
  _eval: while (true) {
    var x1 = expr;
    if ($is_Lcalculator_Literal(x1)) {
      ...
      if ($s_sc_LinearSeqOptimized$class__contains__sc_LinearSeqOptimized__O__Z(this$1, name)) {
        ...
        var this$2 = acc;
        var temp$acc = new $c_sci_$colon$colon().init___O__sci_List(name, this$2);
        expr = temp$expr;
        acc = temp$acc;
        continue _eval
      }
      ...
      var a = x4.a$2;
      var b = x4.b$2;
      return (this.eval$1__p1__Lcalculator_Expr__sci_Map__sci_List__D(a, references, acc) + this.eval$1__p1__Lcalculator_Expr__sci_Map__sci_List__D(b, references, acc))
    } else if ($is_Lcalculator_Minus(x1)) {
      var x5 = $as_Lcalculator_Minus(x1);
      var a$2 = x5.a$2;
      var b$2 = x5.b$2;
      return (this.eval$1__p1__Lcalculator_Expr__sci_Map__sci_List__D(a$2, references, acc) - this.eval$1__p1__Lcalculator_Expr__sci_Map__sci_List__D(b$2, references, acc))
    } else if ($is_Lcalculator_Times(x1)) {
      var x6 = $as_Lcalculator_Times(x1);
      var a$3 = x6.a$2;
      var b$3 = x6.b$2;
      return (this.eval$1__p1__Lcalculator_Expr__sci_Map__sci_List__D(a$3, references, acc) * this.eval$1__p1__Lcalculator_Expr__sci_Map__sci_List__D(b$3, references, acc))
    } else if ($is_Lcalculator_Divide(x1)) {
      var x7 = $as_Lcalculator_Divide(x1);
      var a$4 = x7.a$2;
      var b$4 = x7.b$2;
      return (this.eval$1__p1__Lcalculator_Expr__sci_Map__sci_List__D(a$4, references, acc) / this.eval$1__p1__Lcalculator_Expr__sci_Map__sci_List__D(b$4, references, acc))
    } else {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, delta$1) {
    return (function() {
      if (($uD(delta$1.apply__O()) < 0)) {
        ...
        var sqrtDelta = $uD($g["Math"]["sqrt"](a$1));
        var array$1 = [(((-$uD(b$2.apply__O())) + sqrtDelta) / (2 * $uD(a$2.apply__O()))), (((-$uD(b$2.apply__O())) - sqrtDelta) / (2 * $uD(a$2.apply__O())))];
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__Lcalculator_Signal__Lcalculator_Signal = (function(signal) {
  $m_Lcalculator_Signal$();
  var expr$1 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, signal$1) {
    return (function() {
      var this$1 = $m_Lcalculator_Calculator$();
      var expr = $as_Lcalculator_Expr(signal$1.apply__O());
      var references = arg$outer.namedExpressions$1$f;
      return this$1.eval$1__p1__Lcalculator_Expr__sci_Map__sci_List__D(expr, references, $m_sci_Nil$())
    })
  })(this, signal));
